...
export default function AnalystLayout({ children }) {
  ...
  return (
    <div className="h-screen flex bg-gray-50 overflow-hidden">
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64  bg-[#f1f7f3] border-r border-gray-200 flex flex-col justify-between h-full overflow-y-auto shrink-0 transform transition-transform duration-300 ease-in-out ${
