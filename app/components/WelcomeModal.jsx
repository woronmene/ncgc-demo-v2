...
export default function WelcomeModal() {
  ...
  const pageContent = {
    "/login": {
      ...
      description:
        "This is the entry point for the National Credit Guarantee Corporation (NCGC) demo platform.",
      sections: [
        {
      ...
      specialNote:
        "Click 'View Demo Credentials' to get started with PFI onboarding credentials.",
    },
    "/ncgc_admin/dashboard": {
      title: "Admin Dashboard",
      description:
        "Overview of all onboarded Partner Financial Institutions (PFIs).",
      sections: [
        {
    ...
    "/ncgc_admin/dashboard/onboard": {
      ...
      description:
        "Register your financial institution as a Partner Financial Institution (PFI) with NCGC. PFIs onboard themselves through this portal.",
      sections: [
        {
          title: "Process",
          items: [
    ...
    "/bank_maker/dashboard/create": {
      ...
      description:
        "Submit a new loan guarantee request to NCGC. Note: This is a loan guarantee application, not a direct loan application.",
      sections: [
        {
          title: "Steps",
          items: [
    ...
    "/ncgc_analyst/loans": {
      ...
      description:
        "Track the performance of active guarantees and monitor repayment status.",
      sections: [
        {
          title: "What You Can Do",
          items: [
    ...
    "/ncgc_analyst/claims": {
      ...
      description:
        "View and manage all claims submitted by PFIs for defaulted loans.",
      sections: [
        {
          title: "What You Can Do",
          items: [
    ...
    "/ncgc_analyst/recovery": {
      ...
      description:
        "Manage recovery processes to reclaim funds from defaulting borrowers after claims have been paid.",
      sections: [
        {
          title: "What You Can Do",
          items: [
  ...
  useEffect(() => {
    ...
    if (pathname.includes("/ncgc_analyst/dashboard/applications/")) {
      ...
      setContent({
        ...
        description:
          "Detailed assessment of a specific loan guarantee application, including risk scoring and claim information.",
        sections: [
          {
            title: "What You Can Do",
            items: [
      ...
      pathname.includes("/bank_maker/dashboard/") &&
      pathname !== "/bank_maker/dashboard/create"
    ) {
      if (pathname.includes("/claim")) {
        setContent({
          title: "Create Claim",
          description:
            "Submit a claim request for a defaulted loan. Claims can be created when a loan exceeds 180 days past due.",
          sections: [
            {
              title: "What You Can Do",
              items: [
        ...
        setContent({
          ...
          description:
            "View the details of your submitted loan guarantee application, including repayment tracking and claim management.",
          sections: [
            {
              title: "What You Can Do",
              items: [
      ...
      setContent({
        ...
        description:
          "Detailed view of a specific loan's performance, including repayment tracking and claim management.",
        sections: [
          {
            title: "What You Can Do",
            items: [
      ...
      setContent({
        ...
        description:
          "Review claim details, verify documentation, and make approval/rejection decisions.",
        sections: [
          {
            title: "What You Can Do",
            items: [
      ...
      setContent({
        ...
        description:
          "Initiate a new recovery process for a defaulted loan where a claim has been paid.",
        sections: [
          {
            title: "What You Can Do",
            items: [
      ...
      pathname.includes("/ncgc_analyst/recovery/") &&
      pathname !== "/ncgc_analyst/recovery"
    ) {
      setContent({
        title: "Recovery Process Details",
        description:
          "View and update the status of a specific recovery process.",
        sections: [
          {
            title: "What You Can Do",
            items: [
      ...
      setContent({
        ...
        description:
          "Navigate through the application to see specific documentation.",
        sections: [],
      });
    }
  }, [pathname]);
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-10 duration-500">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-emerald-50 mt-1">
                  First time on this page? Here's what you can do
                </p>
              </div>
            </div>
            <button
        ...
        <div className="p-8 space-y-6">
                ...
                >
                  ...
                  <ul className="space-y-2.5">
                    {section.items.map((item, i) => (
                      <li
                        key={i}
                        className="text-sm text-gray-600 flex items-start leading-snug"
                      >
                        <ChevronRight
                          size={14}
                          className="text-emerald-400 mr-1.5 mt-0.5 flex-shrink-0"
                        />
                        <span>{item}</span>
                      </li>
                    ))}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-emerald-50 mb-3 leading-relaxed">
                  ...
                  Click it anytime to see detailed help and instructions
                  specific to what you're viewing.
                </p>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 mt-3 border border-white/20">
                  <p className="text-sm text-emerald-50">
                    <strong className="text-white">Tip:</strong> The Guide
                    button is available on every page and automatically shows
                    relevant information for the page you're currently viewing.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border border-gray-200 rounded-xl p-6 bg-gray-50">
            ...
            <p className="text-sm text-gray-700 mb-4">
              For detailed information about the platform, user roles, complete
              workflows, and testing instructions, visit our comprehensive
              documentation page.
            </p>
            <Link
              href="/documentation"
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex items-center justify-between">
          <p className="text-sm text-gray-600">
            This modal won't appear again on this page. Use the Guide button for
            help anytime.
          </p>
          <button
            onClick={handleClose}
